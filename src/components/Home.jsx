   ...
   return (
      <>
         <div className=" px-5 md:px-[5rem] relative w-full  h-[50rem] md:h-[50rem] lg:h-screen flex flex-col justify-center items-center gap-2 bg-transparent">
            ...
            <a href="" className="w-fit h-fit bg-hero-text text-white px-10 py-2 rounded-full mt-5 text-xl font-semibold shadow-md hover:shadow-lg transition-all duration-300 transform md:hover:scale-105 hover:bg-opacity-90 relative z-10">
               Know More
            </a>
